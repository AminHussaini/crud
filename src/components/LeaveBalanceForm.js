...
const LeaveBalanceForm = ({ onSubmit, initialData, onCancel, styles }) => {
              ...
              <div key={key} style={styles.leaveCard}>
                ...
                <div style={styles.leaveInputGroup}>
                  <div style={styles.leaveInputField}>
                    ...
                    <input
                      type="number"
                      value={formData.leaveAllocations[key].total}
                  ...
                  <div style={styles.leaveInputField}>
                    ...
                    <input
                      type="number"
                      value={formData.leaveAllocations[key].used}
                  ...
                  <div style={styles.leaveInputField}>
                    ...
                    <input
                      type="number"
                      value={formData.leaveAllocations[key].remaining}
                      style={styles.smallInput}
                      disabled
                    />
                  </div>
